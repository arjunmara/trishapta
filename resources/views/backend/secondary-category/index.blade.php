                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Secondary Category Management</h3>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>{{trans($trans_path.'general.columns.parent')}}</th>
                                ...
                                @if(!$data['rows']->isEmpty())
                                    ...
                                    @foreach($data['rows'] as $rowData)
                                        <tr>
                                            ...
                                            <td><a href="{{route($base_route.'.edit',['id'=>$rowData->id])}}"
                                                   class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                                                <a href="#" type="button" data-toggle="modal" data-id="{{$rowData->id}}"
                                                   data-target="#modal-danger-{{$rowData->id}}" class="btn btn-danger delete btn-xs"><i
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a id="delete" href="{{route($base_route.'.delete',['id'=>$rowData->id])}}"
